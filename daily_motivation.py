...
3. Provide 2–3 short, practical takeaways in bullet/emoji form,(👉 or 💪 or ✔︎). 
...
5. Format the message with clear line breaks and a line spacing between ideas(empty lines), so it looks visually engaging and easy to read.
